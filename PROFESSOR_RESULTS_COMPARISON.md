...
|---|---|---|
| WSN-DS v2.3 10-seed baseline | Complete | `Results - 10 Seed Run 30 may/wsnds_results_student_A.csv`, `wsnds_results_student_B.csv` |
| WSN-DS v2.3 10-seed with J merge | Complete on `origin/main` | `Results - 10 Seed Run 30 may + J/wsnds_results_student_A.csv`, `wsnds_results_student_B.csv` |
| WSN-DS deployment/runtime proof | Complete on `origin/main` | `Final/wsnds_deployment_qat_outputs/runtime_from_existing_outputs/wsnds_existing_artifact_runtime_summary.csv` |
| WSN-DS fixed-point C export path | Added, reproducible exporter | `hardware_export/export_wsnds_student_a_rfkd_int8.py`, `hardware_export/wsnds_student_a_rfkd_int8_inference.c` |
| Edge-IIoT strict v2.3 stress test | Complete, 5 seeds | `Edge-IIOT-run/edgeiiot_v23_generalization_outputs/edgeiiot_v23_results_student_A.csv`, `student_B.csv` |
| Edge-IIoT literature-comparable selected-capacity run | Preliminary, seeds 42, 123, and 456 checkpoints available | `Final/edgeiiot_v23_literature_comparable_selected_capacity_outputs/edgeiiot_v23_seed_42_checkpoint.json`, `edgeiiot_v23_seed_123_checkpoint.json`, `edgeiiot_v23_seed_456_checkpoint.json` on `origin/main` |
| SHAP teacher-student explanation alignment | Complete for WSN-DS v2.3 | `Results - 10 Seed Run 30 may/cukd_xai_results.json` |

## 3. WSN-DS Primary Results: 10 Seeds

Source: J-inclusive result files from `origin/main:Results - 10 Seed Run 30 may + J/`.
...
Source: `origin/main:Final/wsnds_deployment_qat_outputs/runtime_from_existing_outputs/wsnds_existing_artifact_runtime_summary.csv`.
...
Source: `origin/main:Final/edgeiiot_v23_literature_comparable_selected_capacity_outputs/edgeiiot_v23_seed_42_checkpoint.json`, `edgeiiot_v23_seed_123_checkpoint.json`, and `edgeiiot_v23_seed_456_checkpoint.json`.
...
Source: `Results - 10 Seed Run 30 may/cukd_xai_results.json`.
...
- `Results - 10 Seed Run 30 may/wsnds_results_student_A.csv`
- `Results - 10 Seed Run 30 may/wsnds_results_student_B.csv`
- `origin/main:Results - 10 Seed Run 30 may + J/wsnds_results_student_A.csv`
- `origin/main:Results - 10 Seed Run 30 may + J/wsnds_results_student_B.csv`
- `origin/main:Final/wsnds_deployment_qat_outputs/runtime_from_existing_outputs/wsnds_existing_artifact_runtime_summary.csv`
- `hardware_export/export_wsnds_student_a_rfkd_int8.py`
...
- `hardware_export/README.md`
- `Edge-IIOT-run/edgeiiot_v23_generalization_outputs/edgeiiot_v23_results_student_A.csv`
- `Edge-IIOT-run/edgeiiot_v23_generalization_outputs/edgeiiot_v23_results_student_B.csv`
- `origin/main:Final/edgeiiot_v23_literature_comparable_selected_capacity_outputs/edgeiiot_v23_seed_42_checkpoint.json`
- `origin/main:Final/edgeiiot_v23_literature_comparable_selected_capacity_outputs/edgeiiot_v23_seed_123_checkpoint.json`
- `origin/main:Final/edgeiiot_v23_literature_comparable_selected_capacity_outputs/edgeiiot_v23_seed_456_checkpoint.json`
- `Results - 10 Seed Run 30 may/cukd_xai_results.json`

Local literature/context files:

- `Update - 12 april 2026/CuKD_XAI_MASTER_DOCUMENT.md`
- `Update - 12 april 2026/XAI_IDS_WSN_IoT_Literature_Map_2023_2026.md`
- `Update - 12 april 2026/MONDAY_PRESENTATION_PACK.md`
- `Papers/base_paper.pdf`
- `Papers/sota_wsn_ds_2025.pdf`
- `Papers/alfarra_2025.pdf`
- `Papers/benaddi_2025.pdf`
- `Papers/Metaheuristically optimized deep soft-voting ensemble for explainable and resource-aware signal processing in wireless sensor network intrusion detection.pdf`
