...
DEFAULT_ARTIFACT_DIR = "results/edge_iiot/literature_comparable"
DEFAULT_OUTPUT_DIR = "results/edge_iiot/literature_metric_gap"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--repo-root", default=".", help="Repository root containing the Edge-IIoT results.")
    parser.add_argument("--artifact-dir", default=DEFAULT_ARTIFACT_DIR, help="Directory containing edgeiiot_v23_results.json.")
    parser.add_argument("--git-ref", default="origin/main", help="Git ref used if results are not present locally.")
