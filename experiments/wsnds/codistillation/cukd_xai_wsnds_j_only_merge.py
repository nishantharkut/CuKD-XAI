...
WSNDS_PATH = os.environ.get('WSNDS_PATH', 'data/wsnds/WSN-DS.csv')  # Path to WSN-DS
...
EXISTING_RESULTS_PATH = os.environ.get(
    ...
    str(Path('results') / 'wsnds' / 'legacy_runs' / '2026-05-30-10seed' / 'cukd_xai_results.json'),
)
J_MERGE_OUTPUT_DIR = os.environ.get(
    'J_MERGE_OUTPUT_DIR',
    str(Path('results') / 'wsnds' / 'final_results' / '2026-05-30-10seed-plus-j'),
)
