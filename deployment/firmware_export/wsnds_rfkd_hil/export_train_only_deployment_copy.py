"""COPY of export_train_only_deployment.py — do not confuse with the original.\n\nExport a provenance-locked train-only-scaler RF-KD deployment model.
...
# COPY-ONLY gate: 0.03 matches historically shipped Student B archived export
# (measured macro_f1_fp32 - macro_f1_fixed = 0.026607676617602105 from
# deployment/firmware_export/wsnds_rfkd_hil/generated_student_b_rfkd_hil_full/hil_reference_predictions.csv).
# Original export_train_only_deployment.py is untouched and still uses 0.01.
