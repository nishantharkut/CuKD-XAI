...
def main() -> int:
    ...
    required = {
        ...
        "preprocess_int_metadata.h": require_file(generated_dir / "preprocess_int_metadata.h"),
        "wsnds_preprocess_int16.c": require_file(HARDWARE_DIR / "wsnds_preprocess_int16.c"),
