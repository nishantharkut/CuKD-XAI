...
deployment/deployment/hardware_hil/docs/11_FINAL_POSTPROCESSING_RUNBOOK.md
deployment/deployment/hardware_hil/empty_baselines/esp32c3_serial_baseline/esp32c3_serial_baseline.ino
deployment/deployment/hardware_hil/empty_baselines/arduino_r4_serial_baseline/arduino_r4_serial_baseline.ino
results/hardware_hil/compile_logs/README.md
tests/hardware_deployment_run/test_final_hil_postprocessing.py
```
...
```text
results/hardware_hil/compile_logs/esp32c3_serial_baseline_compile.txt
```
...
```text
results/hardware_hil/compile_logs/arduino_r4_serial_baseline_compile.txt
```
...
results/hardware_hil/reports/final_postprocessing/final_postprocessing_analysis.json
results/hardware_hil/reports/final_postprocessing/hil_fidelity.csv
results/hardware_hil/reports/final_postprocessing/cycles_per_mac.csv
results/hardware_hil/reports/final_postprocessing/model_only_footprint.csv
results/hardware_hil/reports/final_postprocessing/compile_framework_baseline.csv
results/hardware_hil/reports/final_postprocessing/quantization_drift_summary.csv
results/hardware_hil/reports/final_postprocessing/quantization_drift_by_true_class.csv
results/hardware_hil/reports/final_postprocessing/quantization_drift_pairs.csv
results/hardware_hil/reports/final_postprocessing/evidence_traceability.csv
```
