"""Replay WSN-DS vectors only after verifying export, bundle, and device identity."""
...
def verify_export_report(generated_dir: Path, manifest: dict[str, Any]) -> dict[str, Any]:
    ...
    if macro_f1_drop > 0.01:
        raise RuntimeError("Strict export macro-F1 drop exceeds 0.01")
    return report
