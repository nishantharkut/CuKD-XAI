...
- Student A ESP32-C3 metrics: `hardware_hil/results/pi5_esp32c3/full_56200_metrics.json`
- Student A Arduino R4 metrics: `hardware_hil/results/pi5_arduino_r4/full_56200_metrics.json`
- Student B ESP32-C3 metrics: `hardware_hil/results/pi5_esp32c3_student_b/full_56200_metrics.json`
- Student B Arduino R4 metrics: `hardware_hil/results/pi5_arduino_r4_student_b/full_56200_metrics.json`
- Compile summaries: `hardware_hil/compile_logs/*.txt`
