...
BOARD_SPECS = {
    "esp32c3": {
        ...
        "clock_mhz": 160.0,
        "baseline_compile_log": "hardware_hil/compile_logs/esp32c3_serial_baseline_compile.txt",
    },
    "arduino_r4": {
        "label": "Arduino R4 WiFi",
        "clock_mhz": 48.0,
        "baseline_compile_log": "hardware_hil/compile_logs/arduino_r4_serial_baseline_compile.txt",
    },
}
...
RUNS = [
    {
        ...
        "board": "esp32c3",
        "metrics": [
            "hardware_hil/results/pi5_esp32c3/full_56200_metrics.json",
            "hardware_hil/results/esp32c3/full_56200_metrics.json",
        ],
        "mcu_csv": [
            "hardware_hil/results/pi5_esp32c3/full_56200_mcu.csv",
            "hardware_hil/results/esp32c3/full_56200_mcu.csv",
        ],
        "reference_csv": [
            "hardware_export/generated_student_a_rfkd_hil_full/hil_reference_predictions.csv",
            "hardware_export/generated_student_a_rfkd_hil_full_2nd_command/hil_reference_predictions.csv",
        ],
        "compile_log": "hardware_hil/compile_logs/esp32c3_student_a_compile.txt",
    },
    {
        ...
        "board": "arduino_r4",
        "metrics": [
            "hardware_hil/results/pi5_arduino_r4/full_56200_metrics.json",
            "hardware_hil/results/arduino_r4/full_56200_metrics.json",
        ],
        "mcu_csv": [
            "hardware_hil/results/pi5_arduino_r4/full_56200_mcu.csv",
            "hardware_hil/results/arduino_r4/full_56200_mcu.csv",
        ],
        "reference_csv": [
            "hardware_export/generated_student_a_rfkd_hil_full/hil_reference_predictions.csv",
            "hardware_export/generated_student_a_rfkd_hil_full_2nd_command/hil_reference_predictions.csv",
        ],
        "compile_log": "hardware_hil/compile_logs/arduino_r4_student_a_compile.txt",
    },
    {
        "id": "student_b_esp32c3",
        "model": "student_b",
        "board": "esp32c3",
        "metrics": ["hardware_hil/results/pi5_esp32c3_student_b/full_56200_metrics.json"],
        "mcu_csv": ["hardware_hil/results/pi5_esp32c3_student_b/full_56200_mcu.csv"],
        "reference_csv": ["hardware_export/generated_student_b_rfkd_hil_full/hil_reference_predictions.csv"],
        "compile_log": "hardware_hil/compile_logs/esp32c3_student_b_compile.txt",
    },
    {
        "id": "student_b_arduino_r4",
        "model": "student_b",
        "board": "arduino_r4",
        "metrics": ["hardware_hil/results/pi5_arduino_r4_student_b/full_56200_metrics.json"],
        "mcu_csv": ["hardware_hil/results/pi5_arduino_r4_student_b/full_56200_mcu.csv"],
        "reference_csv": ["hardware_export/generated_student_b_rfkd_hil_full/hil_reference_predictions.csv"],
        "compile_log": "hardware_hil/compile_logs/arduino_r4_student_b_compile.txt",
    },
]
...
def main() -> int:
    ...
    parser.add_argument("--project-root", default=".", help="Path to `Hardware Deployment Run`.")
    parser.add_argument("--output-dir", default="hardware_hil/reports/final_postprocessing")
