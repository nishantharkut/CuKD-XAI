...
DEFAULT_OUTPUT = (
    ...
    / "fgds_seed42_reconstructed_teacher_shap_v2"
)
PROTOCOL_ID = "wsnds_fgds_seed42_reconstructed_teacher_permutation_shap_v2"
KD_TEMPERATURE = 4.0
FEATURE_NAMES = [
    "Time",
    "Is_CH",
...
def run_permutation_shap(
    ...
    job_contract = {
        ...
        "explainer": "shap_permutation_with_independent_masker",
    }
...
def main() -> int:
    ...
    report = {
        ...
        "method": {
            "explainer": (
                "model-agnostic permutation SHAP with shap.maskers.Independent for all "
                "three subjects"
            ),
            "masker_boundary": (
