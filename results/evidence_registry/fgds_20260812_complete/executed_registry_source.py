...
DEFAULT_OUTPUT = REPO_ROOT / "results/evidence_registry/fgds_20260812_complete"
...
def build_registry() -> dict[str, Any]:
    ...
    return {
        "status": "passed",
        "registry_id": "cukd_fgds_evidence_registry_20260812_v2",
...
def verify_existing_registry(output: Path) -> dict[str, Any]:
    ...
    require(
        persisted.get("registry_id") == "cukd_fgds_evidence_registry_20260812_v2",
